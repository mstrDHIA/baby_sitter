...
import 'package:babysitter_v1/src/view/screens/space/babysitter/register_steps.dart';
import 'package:babysitter_v1/src/view/screens/space/babysitter/title_baby.dart';
...
class IdentitBabySitterTapeTwoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final controller = Get.put(IdentitBabySitterTapeTwoController());
              ...
              RichText(
                text: TextSpan(
                  children: [
                    ...
                    TextSpan(
                      text:
                          "claires de votre pièce d'identité (recto et verso)",
                      style: TextStyle(
