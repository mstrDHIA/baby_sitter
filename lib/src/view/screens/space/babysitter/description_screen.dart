...
class RegisterBabySitterEtapeOneScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<DescriptionController>(
      builder: (_) {
        print(AppCache.instance.getRole());
        return SafeArea(
          child: Scaffold(
            body: Form(
              ...
              child: ListView(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  AuthInput(
                    hintText: (controller.role=='parent')?"e.g. Les activitees des enfants, des besoins specifique ...":"e.g. 5 ans d'expérience en garde d'enfants",
                    controller: controller.descriptionController,
                    maxLines: 5,
                  ),
                  SizedBox(height: 10),
                  AuthLabel((controller.role=='parent')?"Nombre enfants":"Années d'expérience"),
                  SizedBox(height: 10),
                  TextFormField(
